...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`echocloud_saimo_weekreport` /*!40100 DEFAULT CHARACTER SET utf8 */;

USE `echocloud_saimo_weekreport`;
...
/*Table structure for table `work_week_report` */

DROP TABLE IF EXISTS `work_week_report`;

CREATE TABLE `work_week_report` (
...
/*Data for the table `work_week_report` */

insert  into `work_week_report`(`id`,`project_id`,`user_id`,`user_name`,`nick_name`,`work_type`,`work_count`,`work_description`,`current_week`,`work_hour_time`,`report_time`,`start_time`,`end_time`,`remark`) values
